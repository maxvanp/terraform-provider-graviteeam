...
func TestOrgGroupCreateReadUpdateAndDeleteReportInvalidStateData(t *testing.T) {
	t.Parallel()
	...
	raw := tftypes.NewValue(
		...
		map[string]tftypes.Value{
			...
			"name":        tftypes.NewValue(tftypes.String, "admins"),
	...
	validPlan := orgGroupPlan(t, schemaResp.Schema, OrgGroupModel{
		Name:        types.StringValue("admins"),
