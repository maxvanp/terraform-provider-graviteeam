...
func TestDeviceIdentifierCreateReadUpdateAndDeleteReportInvalidStateData(t *testing.T) {
	t.Parallel()
	...
	raw := tftypes.NewValue(
		...
		map[string]tftypes.Value{
			"id":            tftypes.NewValue(tftypes.String, "device-123"),
			"domain_id":     tftypes.NewValue(tftypes.Number, 123),
			"name":          tftypes.NewValue(tftypes.String, "Fingerprint"),
			"type":          tftypes.NewValue(tftypes.String, "fingerprintjs-v3-am-device-identifier"),
