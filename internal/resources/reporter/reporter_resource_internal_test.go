...
func TestConfigureAllowsNilProviderData(t *testing.T) {
	...
	var resp resource.ConfigureResponse
	(&ReporterResource{}).Configure(context.Background(), resource.ConfigureRequest{}, &resp)
...
func TestReporterCreateReadUpdateAndDeleteReportInvalidStateData(t *testing.T) {
	t.Parallel()
	...
	raw := tftypes.NewValue(
		...
		map[string]tftypes.Value{
			...
			"name":          tftypes.NewValue(tftypes.String, "file reporter"),
