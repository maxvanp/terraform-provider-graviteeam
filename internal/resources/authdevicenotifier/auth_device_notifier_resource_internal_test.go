...
func TestAuthDeviceNotifierCreateReadUpdateAndDeleteReportInvalidStateData(t *testing.T) {
	t.Parallel()
	...
	raw := tftypes.NewValue(
		...
		map[string]tftypes.Value{
			...
			"name":          tftypes.NewValue(tftypes.String, "HTTP Notifier"),
			"type":          tftypes.NewValue(tftypes.String, "http-am-authdevice-notifier"),
