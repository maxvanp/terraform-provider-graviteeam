...
REVIEWED_WITHOUT_GET = {
    ...
    "applicationform/application_form_resource.go:ApplicationFormResource",
    ...
    "authdevicenotifier/auth_device_notifier_resource.go:AuthDeviceNotifierResource",
    "authorizationengine/authorization_engine_resource.go:AuthorizationEngineResource",
    "botdetection/bot_detection_resource.go:BotDetectionResource",
    "certificate/certificate_resource.go:CertificateResource",
    "deviceidentifier/device_identifier_resource.go:DeviceIdentifierResource",
    ...
    "extensiongrant/extension_grant_resource.go:ExtensionGrantResource",
    "factor/factor_resource.go:FactorResource",
    "form/form_resource.go:FormResource",
    "grouproles/group_roles_resource.go:GroupRolesResource",
    "groupmembers/group_members_resource.go:GroupMembersResource",
    "group/group_resource.go:GroupResource",
    ...
    "orgentrypoint/org_entrypoint_resource.go:OrgEntrypointResource",
    "orgform/org_form_resource.go:OrgFormResource",
    "orggroup/org_group_resource.go:OrgGroupResource",
    ...
    "orgreporter/org_reporter_resource.go:OrgReporterResource",
    "orgrole/org_role_resource.go:OrgRoleResource",
    "orgsettings/org_settings_resource.go:OrgSettingsResource",
    "orgtag/org_tag_resource.go:OrgTagResource",
    "orgusertoken/org_user_token_resource.go:OrgUserTokenResource",
    "passwordpolicy/password_policy_resource.go:PasswordPolicyResource",
